...
// ========== Color Tokens (fallback values — CSS variables take precedence when set) ==========
export const colors = {
  // Backgrounds (warm, paper-like)
  bg: "var(--bg, #FAF6F1)",
  bgWarm: "var(--bg-warm, #F5EDE3)",
  surface: "var(--surface, #FFFCF8)",
  surfaceRaised: "var(--surface-raised, #FFFFFF)",
  // Text
  fg: "var(--fg, #2C2420)",
  fgSecondary: "var(--fg-secondary, #5C4E44)",
  muted: "var(--muted, #8C7E72)",
  mutedLight: "var(--muted-light, #B8AEA4)",
  // Borders
  border: "var(--border, #E8E0D8)",
  borderLight: "var(--border-light, #F0EAE2)",
  // Accent
  accent: "var(--accent, #B85C3A)",
  accentHover: "var(--accent-hover, #A04E30)",
  accentBg: "var(--accent-bg, oklch(92% 0.04 45))",
  // Semantic
  success: "var(--success, #6B8E5A)",
  successMuted: "var(--success-muted, rgba(107,142,90,0.12))",
  successBorder: "var(--success-border, rgba(107,142,90,0.25))",
  warning: "var(--warning, #C4943A)",
  warningMuted: "var(--warning-muted, rgba(196,148,58,0.12))",
  warningBorder: "var(--warning-border, rgba(196,148,58,0.25))",
  danger: "var(--danger, #B84A3A)",
  dangerMuted: "var(--danger-muted, rgba(184,74,58,0.12))",
  dangerBorder: "var(--danger-border, rgba(184,74,58,0.25))",
  info: "var(--info, #5A7E8E)",
  infoMuted: "var(--info-muted, rgba(90,126,142,0.12))",
  infoBorder: "var(--info-border, rgba(90,126,142,0.25))",
  // Primary (green for actions)
  primary: "var(--primary, #6B8E5A)",
  primaryHover: "var(--primary-hover, #5A7A4A)",
  primaryMuted: "var(--primary-muted, rgba(107,142,90,0.12))",
  primaryBorder: "var(--primary-border, rgba(107,142,90,0.25))",
  // Aliases for backward compatibility
  textMuted: "var(--muted, #8C7E72)",
  textDim: "var(--muted-light, #B8AEA4)",
  textSecondary: "var(--fg-secondary, #5C4E44)",
  text: "var(--fg, #2C2420)",
  dangerBg: "var(--danger-bg, rgba(184,74,58,0.12))",
  bgElevated: "var(--surface-raised, #FFFFFF)",
  warningBg: "var(--warning-bg, rgba(196,148,58,0.12))",
};
