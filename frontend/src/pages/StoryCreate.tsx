...
const s = {
  ...
  formTextarea: { width: "100%", padding: "10px 14px", border: "1px solid " + colors.border, borderRadius: "6px", background: colors.surface, fontSize: "14px", fontFamily: "inherit", color: colors.fg, resize: "vertical", minHeight: "80px", lineHeight: 1.6 },
  tagSelector: { display: "flex", flexWrap: "wrap", gap: "8px" },
  ...
  stepperValue: { minWidth: "60px", textAlign: "center", fontSize: "15px", fontWeight: 500 },
  previewCard: { position: "sticky", top: "40px", background: colors.surfaceRaised, border: "1px solid " + colors.border, borderRadius: "10px", overflow: "hidden" },
  previewStrip: { height: "4px" },
  previewBody: { padding: "24px" },
  previewLabel: { fontSize: "11px", textTransform: "uppercase", letterSpacing: "0.08em", color: colors.muted, marginBottom: "16px" },
  ...
  previewMeta: { display: "flex", flexWrap: "wrap", gap: "8px", marginBottom: "20px" },
